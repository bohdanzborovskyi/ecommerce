...
export const loginFailure = createAction('[Auth] Login Success', props<{error : any}>());
...
export const registerFailure = createAction('[Auth] Register Success', props<{error : any}>());
